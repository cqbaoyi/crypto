...
''' full channel "received" type '''
#csv_columns = ["type", "order_id", "order_type", "funds", "size", "price", "side", "client_oid", "product_id", "sequence", "time"]
''' ticker channel '''
csv_columns = ["type", "trade_id", "product_id", "time", "side", "price", "last_size", \
               "sequence", "best_bid", "best_ask", "high_24h", "low_24h", \
               "volume_24h", "volume_30d", "open_24h"]
